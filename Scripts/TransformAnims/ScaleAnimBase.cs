...
public abstract class ScaleAnimBase : S4Animations
{
    ...
    {
        mKeys.SKey.Add(KeyAt(step * stepDuration, step));
        mKeys.SKey.Add(KeyAt((step + 1) * stepDuration, step + 1));
    }

    void StepEase(int step, TransformKey mKeys)
    {
        mKeys.SKey.Add(KeyAt(step * stepDuration, step));
        mKeys.SKey.Add(KeyAt((step + 1) * stepDuration - 1, step));
    }

    void EaseInEase(int step, TransformKey mKeys)
    {
        mKeys.SKey.Add(KeyAt(step * stepDuration, step));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.5f), step + 0.25f));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.75f), step + 0.5f));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.875f), step + 0.75f));
        mKeys.SKey.Add(KeyAt((step + 1) * stepDuration, step + 1));
    }
    ...
    {
        mKeys.SKey.Add(KeyAt(step * stepDuration, step));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.125f), step + 0.25f));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.25f), step + 0.5f));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.5f), step + 0.75f));
        mKeys.SKey.Add(KeyAt((step + 1) * stepDuration, step + 1));
    }
    ...
    {
        mKeys.SKey.Add(KeyAt(step * stepDuration, step));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.125f), step + 0.05f));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.25f), step + 0.15f));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.5f), step + 0.5f));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.75f), step + 0.85f));
        mKeys.SKey.Add(KeyAt(step * stepDuration + (int)(stepDuration * 0.875f), step + 0.95f));
        mKeys.SKey.Add(KeyAt((step + 1) * stepDuration, step + 1));
    }

    SKey KeyAt(int frame, float factor)
    {
        SKey key = new SKey();
        key.frame = frame;
